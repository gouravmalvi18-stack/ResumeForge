...
export default function Sidebar({ activeTab, setActiveTab, id }) {
  const navigate = useNavigate();
  const { handleDeleteAReport } = useAi();
  ...
  // Delete a Report when click
  const DeleteReportCard = async () => {
    await handleDeleteAReport(id);
