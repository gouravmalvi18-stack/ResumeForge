        ...
        {Loading ? (
          ...
          <div className="mx-auto flex w-120 flex-col rounded-2xl border-[0.5px] border-white/10 bg-black/10 py-5">
            ...
            <div className="mx-6 mt-7 flex flex-col rounded-2xl border-[0.5px] border-white/10 bg-[#0a0812] pt-4">
              <h2 className="pl-5 text-center text-primary">Create Account</h2>
              <form
              ...
              >
                ...
                <div className="flex w-full flex-col gap-2 px-5">
                  <label className="pl-1 text-sm text-primary font-bold tracking-wide">
                  ...
                  <input
                    ...
                    className="rounded-lg border-[0.5px] border-white/30 px-3 py-2 text-sm text-primary font-bold placeholder-secondary hover:cursor-pointer focus:outline-[0.5px] focus:outline-neutral-300"
                  />
                ...
                <BtnCompo
                  ...
                  BtnType="submit"
                  Name="Signup"
                  className="w-full rounded-b-2xl border border-white/30 py-2 text-center text-primary font-bold hover:cursor-pointer hover:opacity-70"
                />
              </form>
            </div>
            <p className="mt-4 text-center text-secondary">
              Already have a Account?{" "}
              <Link className="text-primary hover:text-red-900" to="/login">
                Login
              </Link>
            </p>
          </div>
